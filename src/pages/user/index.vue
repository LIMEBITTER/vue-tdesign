...
<!--      </card>-->
    ...
    <t-col :flex="1">
      ...
      <card title="人脸" class="user-team" size="small">
        <template #option>
          <t-button theme="default" shape="square" variant="text">
            <t-icon name="edit" size="18" />
          </t-button>
        </template>
        <t-avatar size="90px">face</t-avatar>
        <div class="name">
          <t-button block size="large"  @click="visible1 = true">录入/修改人脸</t-button>

        </div>
        <t-dialog  :closeBtn="false" :visible.sync="visible1" @confirm="onConfirm" :onClose="close1">
          <div slot="header">
            <icon name="check-circle-filled" color="orange" />
            <span style="vertical-align: middle">录入/修改人脸</span>
            <t-upload
              v-model="files"
